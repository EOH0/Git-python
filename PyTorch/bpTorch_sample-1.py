...
# 데이터셋 로드
train_dataset = CustomImageDataset(root='C:\\Users\\LG\\AppData\\Local\\Programs\\Python\\Python38\\pythonCNNTest\\dataset\\train', transform=transform)
train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True)

validation_dataset = CustomImageDataset(root='C:\\Users\\LG\\AppData\\Local\\Programs\\Python\\Python38\\pythonCNNTest\\dataset\\validation', transform=transform)
